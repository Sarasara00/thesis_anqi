...
#didn't use this WL method in this approach
...
def main(args):
    ...
    similar_doc = model.docvecs.most_similar('g_solution103')
    print(similar_doc[0])
    similar_doc_15 = model.docvecs.most_similar('g_expert14')
    print(similar_doc_15[0])
